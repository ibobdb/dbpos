...
export default function Cashier() {
  ...
  const user_id = getUser().user.userId;
  ...
  const onCreateTransaction = (e) => {
    ...
    Swal.fire({
      title: 'Pastikan keranjang belanja telah sesuai',
      text: 'Lanjutkan ?',
      showCancelButton: true,
      ...
      if (results.isConfirmed) {
        setLoading(true)
        setTimeout(async () => {
          await transactionAPI.createTransaction(data).then(response => {
            Swal.fire({
              title: `Transaksi berhasil, Kembalian:${rupiah(change)}`,
              icon: 'success',
            })
            const sendToPrint = {
        ...
        <div className="row">
          <div className="col-md-8">
            ...
            <div className={`dropdown-search-product ${search ? 'show' : ''}`}>
              ...
              <Loading show={pencarianLoading} />
              {dataProduct.length <= 0 ?
                <div className="text-center">
                  <span className="text-muted fst-italic">Produk tidak ditemukan.. :(</span>
                </div> :
          ...
          <div className="col-md-4">
            ...
            <hr />
            <div className="">
              <span className="total-font">Rp. {total && rupiah(total)}</span>
          ...
          <div className="detail-pembayaran">
            <form action="post" onSubmit={onCreateTransaction}>
              <div className="form-group">
                ...
                <input type="text" className="form-control" readOnly disabled value={rupiah(total)} />
              </div>
              <div className="form-group">
                <span className="text-muted">Kembalian</span>
                <input type="text" className="form-control" readOnly disabled value={rupiah(change)} />
              </div>
              <div className="form-group">
                <span className="text-muted">Masukan uang pembayaran</span>
